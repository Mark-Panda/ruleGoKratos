...
let index = 0;
export const CiGitPushNodeRegistry: FlowNodeRegistry = {
  type: WorkflowNodeType.GitPush,
  info: {
    icon: iconLink,
    description: 'ci/gitPush：推送本地仓库到远程。',
  },
  meta: {
    defaultPorts: [
    ...
    return {
      ...
      data: {
        ...
        inputsValues: {
          ...
          refSpecs: {
            type: 'constant',
            content: 'refs/heads/main:refs/heads/main',
          },
