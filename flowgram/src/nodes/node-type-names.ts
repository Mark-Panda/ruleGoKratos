...
export const NODE_TYPE_NAMES: Record<string, string> = {
  ...
  [WorkflowNodeType.CursorCli]: 'Cursor-CLI',
  [WorkflowNodeType.CursorCliAuth]: 'Cursor授权检查',
  [WorkflowNodeType.CursorAcp]: 'Cursor-ACP',
  [WorkflowNodeType.FeishuWebhook]: '飞书机器人',
  [WorkflowNodeType.FeishuCliAuth]: '飞书授权检查',
