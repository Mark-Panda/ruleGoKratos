...
func wireApp(bootstrap *conf.Bootstrap, logger log.Logger) (*kratos.App, func(), error) {
	...
	grpcServer := server.NewGRPCServer(confServer, ruleGoService, runLogService, componentService, adminService, chatService, taskBoardService, logger)
	...
	httpServer := server.NewHTTPServer(confServer, ruleGoService, runLogService, componentService, adminService, chatService, playgroundService, taskBoardService, logger)
